...
/**
 * Base exception for all service exceptions thrown by api
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DemoServiceException extends com.amazonaws.SdkBaseException implements BaseException {
    ...
    /**
     * Constructs a new DemoServiceException with the specified error message.
     *
     * @param message
    ...
    @Override
    public DemoServiceException sdkHttpMetadata(SdkErrorHttpMetadata sdkHttpMetadata) {
